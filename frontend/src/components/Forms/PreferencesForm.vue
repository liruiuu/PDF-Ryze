    ...
    <div>
        ...
        <div>
            <a-form :label-col="{ span: 2 }" :wrapper-col="{ offset: 0, span: 18 }" style="margin-top: 20px;">
                ...
                <a-form-item label="更新下载" :label-col="{ sm: { span: 0 } }" style="margin-top: -20px;">
                    <a-button type="link" @click="OpenUrl('https://hn78hj76p2.feishu.cn/docx/SC2ldCwwMo0nKUx7BU1ceLxInog')">
                        https://hn78hj76p2.feishu.cn/docx/SC2ldCwwMo0nKUx7BU1ceLxInog
                    </a-button>
                </a-form-item>
                
                <a-form-item label="微信公众号"  :label-col="{ sm: { span:0 } }" style="margin-top: -20px;">
                             <img alt="Vue logo" class="logo" src="./images/luban.jpg" width="125" height="125"  />
                </a-form-item>

               <!-- <a-row>
                     <a-col :span="8">
                       <a-form-item label="微信公众号"  :label-col="{ sm: { span:0 } }" :wrapper-col="{ offset: 0, span: 24 }" style="margin-top: -20px;">
                             <img alt="Vue logo" class="logo" src="./images/luban.png" width="125" height="125"  />
                       </a-form-item>
                     </a-col>

                    <a-col :span="12">
                       <a-form-item label="QQ群“871334662”" :label-col="{ sm: { span: 0 } }" :wrapper-col="{ offset: 0, span:24 }" style="margin-top: -20px;">
                             <img alt="Vue logo" class="logo" src="./images/QQqun.png" width="125" height="125" />
                       </a-form-item>
